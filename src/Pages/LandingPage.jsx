...
<div>
  ...
  <ul
    className={`md:flex hidden  md:justify-around items-center lg:text-[16px] text-[10px]  w-[auto] md:gap-12 gap-1 md:flex-row flex-col    md:bg-transparent  cursor-pointer`}
  >
  ...
  <div
    className={`cursor-pointer hidden   md:flex justify-center items-center flex-grow-0 flex-shrink-0 w-[200px] h-14 relative gap-3 px-[69px] py-3.5 rounded-[30px] bg-[#0B0121] border-2 border-green-500 p-8`}
  >
    <svg
      width="21"
      height="18"
  ...
  <div
    className={` ${
      toogle
        ? " cursor-pointer  flex justify-center items-center flex-grow-0 flex-shrink-0 w-[200px] h-14 relative gap-3 px-[69px] py-3.5 rounded-[30px] bg-[#0B0121] border-2 p-8 "
        : "hidden"
    }`}
  >
    <svg
    ...
    <p className=" flex-grow-0 flex-shrink-0 text-base text-center  text-transparent bg-clip-text bg-gradient-to-r from-green-600 from-50%  via-green-700/100 to-green-600 to-80%    ">
      <Link to="/dashboardHome" className="link-to-dashboard text-center">Connect Wallet</Link>
    </p>
  </div>
