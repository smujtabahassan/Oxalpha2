...
const ProfileHeader = () => {
  return (
    <div>
      <div className="w-full  flex flex-col md:mr-0 ml-4  md:items-center items-start py-[1rem]">
      ...
      <div className=" absolute gradient w-[615.236px] h-[615px] top-[8%] right-[1%] "></div>
    </div>
  );
};
