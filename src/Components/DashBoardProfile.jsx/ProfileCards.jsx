        ...
        {cards.map(
          ({ id, image, heading, text, text1, bid, ETH, time }, index) => {
            return (
              <div
                key={index}
                className="md:w-[50%] sm:w-[40%] w-[90%]  flex  justify-between py-[1rem] px-[1rem] my-[1rem] transition-all ease-in-out delay-250 items-center cursor-pointer hover:text-[#44DD68] bg-[rgba(0, 0, 0, 0.40)] hover:bg-[#292828]"
                style={{
                  borderRadius: "16px",
